              ...
              {upload_type === 0 ? (
                getVideoThumbnailUrl(upload_type, lectureUrl) && (
                  <Image
                    ...
                    quality={75}
                    placeholder="blur"
                    blurDataURL="data:image/jpeg;base64,"
                  />
                )
              ) : (
                <video
